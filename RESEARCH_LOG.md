...
| R3 | 2026-08-05 | options | yes | Options trades are not independent; clustered inference changes a verdict | design effect vs shuffled null | ADOPTED | n=1 | HANDOFF_edge_audit.md Part 6 (deff 1.848 vs null p95 1.266; overturns nothing) |
