...
- **THE SURFACE-ANOMALY FAMILY IS NULL ON ALL THREE ARMS — AND THE PRIOR LANE'S ONE SUGGESTIVE
  ...
  * **Options `N` 258 → 261** (one per arm, exactly as pre-committed); **equity untouched at 158**,
    `BACKTEST_RESULTS.json` needs no re-run. Expectations scored **4 right, 2 wrong** — the misses
