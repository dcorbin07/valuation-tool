...
**Session date:** 2026-07-30 (P5 + held-out confirmation + P6)
**Branch:** `worktree-p6-costs-and-robustness` (P5 is already merged to `main` at 958ae16)

> **Scope:** P5 (sections 0-8) then P6 (section P6 below). Canonical numbers are in
> `BACKTEST_RESULTS.json`, regenerated by the final run; this file is the interpretation.
